...
Regular deals: $300 domestic / $550 international
Mistake fares: Under $200 domestic / $350 international
...
# Price thresholds - UPDATED: Increased by $100 each
DOMESTIC_THRESHOLD = 300           # Regular deal threshold
DOMESTIC_MISTAKE = 200             # Likely mistake threshold
INTERNATIONAL_THRESHOLD = 550      # Regular deal threshold
INTERNATIONAL_MISTAKE = 350        # Likely mistake threshold
ORIGIN = "ATL"
...
if __name__ == "__main__":
    scan_for_deals()
    sys.exit(0)  # Always exit cleanly - no deals found is NOT a failure
